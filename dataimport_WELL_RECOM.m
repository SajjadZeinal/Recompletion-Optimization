...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\Recompletion\Assareh Comments Solving\WECON\WECON.PRT');
A3=fscanf(fileID,'%c');
...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\Recompletion\Assareh Comments Solving\WECON\WECON.FUNSMRY');
A2=fscanf(fileID,'%c');
...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\Recompletion\Assareh Comments Solving\WECON\WECON.RSM');
A=fscanf(fileID,'%c');
