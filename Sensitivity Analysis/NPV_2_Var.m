...
OIL_BOTTOM_COMPLETION_DEPTH =15050;
TIME_RECOMP_str=num2str(TIME_RECOMP);
END_SIMULATION_TIME_str = num2str(END_SIMULATION_TIME);
[RECOMP_BLOCK_NO,LENGTH_RECOMPLETED_BLOCK]=FUN_RECOMP_TRANSLATION_DEPTH(RECOMP_TOP_BLOCK_DEPTH,OIL_BOTTOM_COMPLETION_DEPTH);
...
TOTAL_VERTICAL_BLOCK_NO = TOTAL_OIL_BLOCK_NO + 100;
...
fid=fopen('H:\Univercity documents\master\Project\Work over\Final\Recompletion\Sensitivity Analysis\Anisotropy\KvKh=0.6\KvKh=0.6.data','r');
...
SCHEDULE_OUT(MULTPV+31:MULTPV+31+length(RECOMP_BLOCK_NO_str)-1)=RECOMP_BLOCK_NO_str;
...
% Water Zone EDIT
TOP_WATER_ZONE_BLOCK_str=num2str(TOTAL_OIL_BLOCK_NO + 1);
SCHEDULE_OUT(DZ_edit+125:DZ_edit+128)='    ';
SCHEDULE_OUT(DZ_edit+125:DZ_edit+125+length(TOP_WATER_ZONE_BLOCK_str)-1)=TOP_WATER_ZONE_BLOCK_str;
SCHEDULE_OUT(DZ_edit+130:DZ_edit+133)='    ';
SCHEDULE_OUT(DZ_edit+130:DZ_edit+130+length(TOTAL_VERTICAL_BLOCK_NO_str)-1)=TOTAL_VERTICAL_BLOCK_NO_str;




SCHEDULE_OUT(TIME_RECOMP_EDIT+35:TIME_RECOMP_EDIT+44)='          ';
SCHEDULE_OUT(TIME_RECOMP_EDIT+35:TIME_RECOMP_EDIT+35+length(TIME_RECOMP_str)-1)=TIME_RECOMP_str;
SCHEDULE_OUT(END_TIME_RECOMP_EDIT+33:END_TIME_RECOMP_EDIT+42)='          ';
...
fid=fopen('H:\Univercity documents\master\Project\Work over\Final\Recompletion\Sensitivity Analysis\Anisotropy\KvKh=0.6\KvKh=0.6.data','w');
fwrite(fid,SCHEDULE_OUT);
fclose(fid);
system('"C:\ecl\macros\eclrun.exe" eclipse "H:\Univercity documents\master\Project\Work over\Final\Recompletion\Sensitivity Analysis\Anisotropy\KvKh=0.6\KvKh=0.6.data"');
