...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\Recompletion\Sensitivity Analysis\LENGTH\Data file\110-Z-Grids.PRT');
A3=fscanf(fileID,'%c');
...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\Recompletion\Sensitivity Analysis\LENGTH\Data file\110-Z-Grids.FUNSMRY');
A2=fscanf(fileID,'%c');
...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\Recompletion\Sensitivity Analysis\LENGTH\Data file\110-Z-Grids.RSM');
A=fscanf(fileID,'%c');
