...
fid=fopen('H:\Univercity documents\master\Project\Work over\Final\Recompletion\Sensitivity Analysis\LENGTH\Data file\110-Z-Grids.data','r');
...
fid=fopen('H:\Univercity documents\master\Project\Work over\Final\Recompletion\Sensitivity Analysis\LENGTH\Data file\110-Z-Grids.data','w');
fwrite(fid,SCHEDULE_OUT);
fclose(fid);
system('"C:\ecl\macros\eclrun.exe" eclipse "H:\Univercity documents\master\Project\Work over\Final\Recompletion\Sensitivity Analysis\LENGTH\Data file\110-Z-Grids.data"');
...
NPV_MATRIX(1:length(NPV),attempt2+8)=RECOMP_TOP_BLOCK_DEPTH;
attempt2 = attempt2 + 9;
cal_NPV=totNPV;
fclose all;
end
