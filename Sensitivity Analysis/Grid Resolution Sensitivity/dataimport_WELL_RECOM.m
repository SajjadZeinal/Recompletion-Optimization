...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\Recompletion\Compare\Recompletion\Recompletion.PRT');
A3=fscanf(fileID,'%c');
...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\Recompletion\Compare\Recompletion\Recompletion.FUNSMRY');
A2=fscanf(fileID,'%c');
...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\Recompletion\Compare\Recompletion\Recompletion.RSM');
A=fscanf(fileID,'%c');
