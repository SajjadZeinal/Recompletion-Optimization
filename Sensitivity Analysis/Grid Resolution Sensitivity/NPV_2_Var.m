...
fid=fopen('H:\Univercity documents\master\Project\Work over\Final\Recompletion\Optimization\Data\110-Z-Grids.data','r');
...
fid=fopen('H:\Univercity documents\master\Project\Work over\Final\Recompletion\Optimization\Data\110-Z-Grids.data','w');
fwrite(fid,SCHEDULE_OUT);
fclose(fid);
system('"C:\ecl\macros\eclrun.exe" eclipse "H:\Univercity documents\master\Project\Work over\Final\Recompletion\Optimization\Data\110-Z-Grids.data"');
