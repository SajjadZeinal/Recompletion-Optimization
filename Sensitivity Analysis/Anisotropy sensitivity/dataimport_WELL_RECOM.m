...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\Recompletion\Assareh Comments Solving\Recompletion.PRT');
A3=fscanf(fileID,'%c');
...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\Recompletion\Assareh Comments Solving\Recompletion.FUNSMRY');
A2=fscanf(fileID,'%c');
...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\Recompletion\Assareh Comments Solving\Recompletion.RSM');
A=fscanf(fileID,'%c');
